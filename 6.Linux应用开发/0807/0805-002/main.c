...
int main()
{
    char *dbPath="database";
    linkList *list = initLinkList();
    loadLinkList(list,sizeof(student),dbPath,inputStudent);
    char num[8]; 
    while (1)
        switch (studentMenu())
        {
        ...
        case '1':
        {
            ...
            linkNode *newStu = inputStudent((linkNode*)&s);
            getStudentSum(newStu);
            insertLinkList(list, 0, newStu);
            getStudentSum(getLinkListNode(list,0));
        }
        break;
            // TODO:删除
        case '2':
        ...
        case '3':
        {
            ...
            getStudentSum(getLinkListNode(list,pos));
        }
        break;
        case '4':
        {
        ...
        case '0':
            // TODO:保存数据
            saveLinkList(list,sizeof(student),dbPath);
            //TODO:退出
            //TODO:安全删除现有节点后释放链表
